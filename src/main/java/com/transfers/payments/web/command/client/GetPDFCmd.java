...
import com.transfers.payments.db.entity.Payment;
import com.transfers.payments.exception.AppException;
import com.transfers.payments.exception.DBException;
...
public class GetPDFCmd extends Command {
    ...
    private String getPdf(long paymentId) throws DocumentException, IOException, DBException {
        ...
        Image image2 = Image.getInstance("C:\\data\\webServers\\payments\\src\\main\\webapp\\img\\money.png");
